---
title: "Start Here: A Map to National Service in Singapore"
...
Not sure where to begin? This page is like the MRT map. Find the section that sounds like you, then follow the links.

## If you are a pre-enlistee

You have NS coming, or you're trying to figure out what it involves.

### You want to understand what NS is
...
- What PES status means: [PES status](/pes)
- Getting a better PES: [up-PESing](/guide-on-uppes) and [what Attend C means](/what-is-attend-c)
- Glasses rules: [glasses requirement](/glasses-requirement)
- What the CMPB screening involves: [FAQ](/faq)

### You want to shop and pack before enlisting
...
- The full guide: [BMT guide](/basic-military-training) or the [BMT Hub](/bmt-hub)
- Check your fitness: [IPPT calculator](/ippt)
- Your enlistment date: [enlistment dates](/dates)

### You are studying or living overseas

- Overseas process: [CMPB overseas pre-enlistees](https://www.cmpb.gov.sg/before-ns/overseas-pre-enlistees/)

## If you are an NSF

You're already serving, in BMT or a unit.
...
### You want to go to command school

- How selection works: [command school](/command-school)
- Specialist Cadet School: [SCS Hub](/scs-hub) and [SCS tips](/scs-tips)
...
- Your allowance: [NSF allowance](/nsf-allowance)
- Saving money: [saving money](/saving-money) and [eMart credits](/emart-credits)
- Filling free time: [free time](/free-time), [movies](/movies), [best canteen dishes](/best-canteen-dishes), [songs](/songs)

### You are about to ORD

- Count down: [ORD countdown](/ord-countdown) and [Telegram bots](/telegram-bots)
...
- The big picture: [BMT guide](/basic-military-training) and the [BMT Hub](/bmt-hub)

### You want to help him prepare before enlistment

- What to settle first: [before enlistment checklist](/before-enlistment)
- Haircut and glasses rules: [hair requirement](/hair-requirement) and [glasses requirement](/glasses-requirement)

### You need to reach someone or report a concern

- Hotlines and contacts: [contact](/contact)

## If you are just curious

Maybe you're from outside Singapore, or you just want to understand what NS is.

### You want the basics

- What NS actually is: [BMT guide](/basic-military-training)
- How the different jobs work: [vocations](/vocations)
