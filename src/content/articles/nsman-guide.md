...
- **Update your details on the NS portal.** Keep your contact, address, bank, and employment info current on the [OneNS portal and app](https://www.ns.gov.sg/). That's how they reach you for call-ups and pay you.
...
Full scoring, the calculator, and tips: [IPPT calculator and guide](/ippt).
...
These rules change, so confirm current details on the [official exit permit page](https://www.ns.gov.sg/) before a long trip.

## Tools and contacts

- **[OneNS portal and app](https://www.ns.gov.sg/):** call-ups, IPPT and NS FIT, payments, exit permit, eMart, and your profile, all in one place.
- **[Useful apps](/apps)** and **[Telegram bots](/telegram-bots):** handy extras for NS admin.
- **[Contact](/contact):** NS hotline, MINDEF, and emergency numbers.
- **[Useful links](/links):** official resources and forum threads.

## A note for Home Team NSmen

If you served with the Police (SPF) or Civil Defence (SCDF), your call-up, training, and IPPT schemes differ from the SAF. This page is written for SAF NSmen. Check the [MHA NS Portal](https://ns.mha.gov.sg/) for Home Team specifics.
