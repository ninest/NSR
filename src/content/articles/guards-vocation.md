---
title: "Guards Vocation: GVT, the Khaki Beret & Guardsman Life"
displayTitle: Guards vocation
description: Guide to the SAF Guards vocation - elite rapid-deployment infantry. Guards Vocation Training (GVT), earning the khaki beret, the fast march and coastal swim, heliborne and amphibious ops, the battalions, and how it compares to infantry.
created: 2026-06-12
updated: 2026-06-12
tags:
  - vocation
...
> Guards overlaps a lot with regular [infantry](/infantry-vocation), just turned up. Read the [infantry page](/infantry-vocation) too, since the stay-in life, outfields, and section culture all apply here, often harder.

## How do you know you're in Guards

Check your **posting order** after [BMT](/basic-military-training). You'll see a **Guards** trooper / guardsman role.

Guards takes **combat-fit** people ([PES](/pes) A and B1) with the fitness to handle a heavier physical load. Postings still go by operational needs, your attributes, and BMT performance.

## Official links
- [Guards vocation - CMPB](https://www.cmpb.gov.sg/ns-vocations/guards/)
- [Guards formation - Singapore Army](https://www.mindef.gov.sg/army/our-forces/formations/guards)
...
When you do get downtime, don't waste the [free time](/free-time):
...
- **[Specialist Cadet School (SCS)](/specialist-cadet-school)** to become a sergeant
- **Officer Cadet School (OCS)** via the [command school](/command-school) route

## Is it worth anything after ORD

Like [infantry](/infantry-vocation), there's no civilian credential, but the **soft value** is real and a notch above:
...
Combat vocations also pay a higher [vocation allowance](/nsf-allowance).

## Read next
- [Infantry vocation](/infantry-vocation): the foundation Guards builds on, with more detail on outfields, IVT, and stay-in life

## Sources
- [Guards vocation - CMPB](https://www.cmpb.gov.sg/ns-vocations/guards/): the official overview
- [Guards formation - Singapore Army](https://www.mindef.gov.sg/army/our-forces/formations/guards): role, ops, and capabilities
- [The Making of a Guardsman - PIONEER](https://www.defencepioneer.sg/pioneer-articles/THE-MAKING-OF-A-GUARDSMAN): the conversion course and khaki beret
- [Guards (Singapore Army) - Wikipedia](https://en.wikipedia.org/wiki/Guards_(Singapore_Army)): formation, battalions, and history
