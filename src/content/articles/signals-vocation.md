---
title: "Signals Vocation: Signaller Life, Courses & Is It Chill?"
...
For the units a field signaller might attach to, see [infantry](/infantry-vocation), [armour](/armour-vocation), and [guards](/guards-vocation).

## How do you know you're in signals

Check your **posting order** after [BMT](/basic-military-training). Signals usually shows up as something like:

- **Signal Operator (Trainee)**
- **Signaller**
- A specific course like **Infocomm** or **Infosystem (IS)**

Postings go by operational needs, [PES](/pes) and medical fitness, [IPPT](/ippt) and BMT performance, plus your attributes. Signals takes a fair range of **PES A and B** people, and some courses screen for **education or aptitude**.

## Official links
- [Signals vocation - CMPB](https://www.cmpb.gov.sg/ns-vocations/signals/)
- [Signals - Singapore Army](https://www.mindef.gov.sg/army/our-forces/formations/signals)
- [NS Vocations Handbook (PDF)](/ns-vocations-handbook.pdf)

## The path

Signallers go to the **Signal Institute (SI)** after finishing the BMT route assigned by your [PES](/pes) and pre-enlistee [IPPT](/ippt). For combat-fit PES A or B1 enlistees who pass the pre-enlistee IPPT, that's the standard **9-week BMT** before vocational training.
...
| -- | -- |
| **Army Cyber Defence** | Digital defence systems: military network monitoring, threat assessment, and cyber defence. The most IT and security flavoured track. |
| **Infocomm 1** | High-bandwidth, long-distance and **satellite** comms. Includes a driving course to deploy the systems. |
...
- **[Specialist Cadet School (SCS)](/specialist-cadet-school)**: train to become a Signals **3SG**, with Signals pro-term back at Stagmont/SI.
...
Not really. Course and posting come down to needs, your profile, and performance during training. You can [indicate interest](/vocations) but it's not a guarantee.
...
- [Signals (Singapore Army) - Wikipedia](https://en.wikipedia.org/wiki/Signals_(Singapore_Army)): Signal Institute and battalion structure
